...
export const templates: WorkflowTemplate[] = [
  {
    ...
    description:
      "Validate account age and merge history before allowing contributions.",
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { action: "log", message: "Trusted contributor" },
      },
      {
        id: "action_2",
        type: "action",
        ...
        data: {
          action: "block",
          message: "Account does not meet requirements",
        },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { rule: "cryptoAddressDetection" },
      },
      {
        id: "action_1",
        type: "action",
        position: { x: 200, y: 390 },
        data: { action: "block", message: "Spam detected" },
      },
      {
        id: "action_2",
        type: "action",
        position: { x: 420, y: 390 },
        data: { action: "add_to_blacklist" },
      },
    ],
    edges: [
      {
  ...
  },
  {
    ...
    name: "History Scan",
    description:
      "Score past contributors and flag low-trust accounts for review.",
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { field: "score", operator: "<", value: 30 },
      },
      {
        id: "action_1",
        type: "action",
      ...
      },
      {
        ...
        data: { action: "log", message: "Flagged for review" },
      },
    ],
    edges: [
      {
  ...
  },
  {
    ...
    description:
      "Require profile completeness and repo activity from new contributors.",
    ...
    nodes: [
      {
        ...
        type: "trigger",
        position: { x: 300, y: 50 },
        data: { trigger: "contributor_first_interaction" },
      },
      {
        id: "transform_1",
        type: "transform",
      ...
      },
      {
        ...
        data: { rule: "requireProfileReadme" },
      },
      {
        id: "rule_2",
        type: "rule",
      ...
      },
      {
        ...
        type: "action",
        position: { x: 150, y: 540 },
        data: { action: "label", label: "needs-review" },
      },
      {
        id: "action_2",
        type: "action",
        ...
        data: {
          action: "warn",
          message: "Please complete your GitHub profile",
        },
      },
    ],
    edges: [
