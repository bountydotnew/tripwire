...
import { SaveBarSuccessCheckIcon12 } from "@tripwire/ui/icons/app-chrome-icons"
            ...
            <AnimatePresence>
              {isDropdownOpen ? (
                <motion.div
                  ...
                  className="absolute right-0 bottom-full left-0 mb-1.5"
                >
                  <div
