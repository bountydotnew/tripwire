...
const routeApi = getRouteApi("/_app/$orgHandle/rules/custom/")

export function CustomRulesHubPageSkeleton() {
  return (
...
export function CustomRulesHubPage() {
  ...
  if (isLoading) {
    return <CustomRulesHubPageSkeleton />
  }
