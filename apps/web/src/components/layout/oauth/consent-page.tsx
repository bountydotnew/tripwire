...
type ConsentState = "idle" | "submitting" | "success" | "denied" | "error"

/**
 * OAuth consent screen for third-party apps connecting to a user's
 * Tripwire account. The `consent_code`, `client_id`, and `scope` query
 * params come from the better-auth oauth provider redirect.
 */
