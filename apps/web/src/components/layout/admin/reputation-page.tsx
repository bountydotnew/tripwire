...
/**
 * Admin tool to look up a contributor's reputation across every repo,
 * edit counters / score directly, surgically delete events, and
 * re-trigger the score-user Inngest job.
 */
