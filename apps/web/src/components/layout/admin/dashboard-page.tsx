...
/**
 * Cross-org admin overview: signups, installations, recent flagged
 * events, in-flight syncs, and the lowest-reputation contributors
 * active this week. All queries are admin-procedure scoped — gating
 * happens at the tRPC layer.
 */
