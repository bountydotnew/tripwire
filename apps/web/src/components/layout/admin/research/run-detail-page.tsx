...
const routeApi = getRouteApi("/_admin/admin/research/$runId")
...
/**
 * Detail page for a single research run. Polls the status query every
 * 2s while the run is queued/running and switches to on-demand export
 * downloads when it lands in `completed`.
 */
