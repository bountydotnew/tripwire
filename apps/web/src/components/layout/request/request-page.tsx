...
const routeApi = getRouteApi("/request/$owner/$repo")

/**
 * Public-facing review request flow that a flagged contributor lands
 * on from a block notification. Self-serve: pick "unblock" vs
 * "request access", supply a reason, submit. Requires GitHub OAuth
 * so the maintainer sees the actual sender's identity (no spoofing).
 */
