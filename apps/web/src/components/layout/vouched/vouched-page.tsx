...
/**
 * Public directory of users vouched for by Tripwire maintainers, plus
 * the apply-to-be-vouched flow. Page is server-renderable and doesn't
 * read session for the directory itself — only for the apply dialog.
 */
export function VouchedUsersPage() {
  const trpc = useTRPC()
