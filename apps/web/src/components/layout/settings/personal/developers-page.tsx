...
/**
 * Personal developer settings: API keys management. Keys are
 * user-owned post-migration — they work across every workspace the
...
export function DevelopersSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <SettingsSection
        title="API Keys"
        description="Personal keys for the Tripwire API. Each key belongs to your account and works across every workspace you're a member of."
      >
        {revealedKey && (
