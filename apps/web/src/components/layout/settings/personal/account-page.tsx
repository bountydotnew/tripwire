...
/**
 * Personal account page: profile preview, active sessions list,
 * onboarding reset, and the danger zone (sign-out-everywhere + delete).
 * All actions are user-scoped — no org context is read here.
 */
