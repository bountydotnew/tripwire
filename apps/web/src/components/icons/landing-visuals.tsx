        ...
        return (
          <g key={i}>
            <rect
              ...
              rx="4"
              fill={
                a.real ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.04)"
              }
            />
            {a.real ? (
              <>
                ...
                />
                <path
                  d={`M${cx - 4} ${cy + 6} Q${cx - 4} ${cy + 2} ${cx} ${cy + 2} Q${cx + 4} ${cy + 2} ${cx + 4} ${cy + 6}`}
                ...
                <circle
                  ...
                  cy={a.y + S - 1}
                  r="2.5"
                  fill="rgba(52,166,255,0.35)"
                />
                <path
                  d={`M${a.x + S - 2.8} ${a.y + S - 1} l1.2 1.2 2.2-2.2`}
                  stroke="#34A6FF"
                  strokeWidth="0.8"
                  strokeLinecap="round"
              ...
              <>
                ...
                {/* ✕ centered in square */}
                <path
                  d={`M${cx - 2.5} ${cy - 2.5} l5 5 m-5 0 l5-5`}
...
export function MaxFilesChangedViz() {
  ...
  return (
    <svg width="110" height="86" viewBox="0 0 72 56" fill="none">
      {/* folder icon */}
      <path
        d="M8 12 h10 l3 -4 h14 a2 2 0 0 1 2 2 v4"
        stroke="rgba(255,255,255,0.1)"
        strokeWidth="0.8"
        fill="rgba(255,255,255,0.03)"
      />
...
export function RepoActivityViz() {
  ...
  const rows = 4
  const active = [
    2, 5, 10, 11, 14, 18, 19, 20, 23, 25, 27, 29, 30, 31, 33, 34, 35,
  ]
  return (
    <svg width="110" height="86" viewBox="0 0 72 56" fill="none">
        ...
        Array.from({ length: cols }).map((_, c) => {
          ...
          return (
            <rect
              ...
              rx="1"
              fill={
                isActive ? "rgba(52,166,255,0.15)" : "rgba(255,255,255,0.03)"
              }
            />
          )
        })
...
export function ProfileReadmeViz() {
  ...
  return (
    <svg width="110" height="86" viewBox="0 0 72 56" fill="none">
      ...
      <path
        d="M12 26 Q12 22 18 22 Q24 22 24 26"
      ...
      <circle
        ...
        cy="36"
        r="3.5"
        fill="rgba(52,166,255,0.2)"
        stroke="#34A6FF"
        strokeWidth="0.7"
        opacity="0.6"
      />
      <path
        d="M58.5 36 l1.2 1.2 2.2-2.2"
        stroke="#34A6FF"
        strokeWidth="0.8"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      {rows.map((r, i) => (
        <g key={i}>
          <circle
            ...
            fill="rgba(255,255,255,0.05)"
            stroke={
              r.vouched ? "rgba(52,166,255,0.4)" : "rgba(255,255,255,0.08)"
            }
            strokeWidth="0.8"
          />
          <rect
            ...
            rx="1.5"
            fill={
              r.vouched ? "rgba(255,255,255,0.12)" : "rgba(255,255,255,0.05)"
            }
          />
          {r.vouched ? (
            <g>
              <circle
                ...
                cy={r.y}
                r="3"
                fill="rgba(52,166,255,0.18)"
                stroke="#34A6FF"
                strokeWidth="0.7"
                opacity="0.7"
              />
              <path
                d={`M58.5 ${r.y} l1.1 1 1.9-2`}
                stroke="#34A6FF"
                strokeWidth="0.8"
                strokeLinecap="round"
                strokeLinejoin="round"
