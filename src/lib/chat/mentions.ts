...
export function replaceMentionTrigger(value: string, trigger: MentionTrigger): string {
...
export function composeMentionMessage(mentions: ListedUserMention[], text: string): string {
