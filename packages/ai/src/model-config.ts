...
export const MODEL_RATES: Record<string, { input: number; output: number; contextWindow: number }> = {
	"openai/gpt-5.4-mini":  { input: 0.75e-6, output: 4.5e-6, contextWindow: 200_000 },
	"openai/gpt-5.4-nano":  { input: 0.20e-6, output: 1.25e-6, contextWindow: 128_000 },
	"openai/gpt-5.4":       { input: 2.5e-6, output: 15e-6, contextWindow: 200_000 },
	"openai/gpt-4o-mini":   { input: 0.15e-6, output: 0.6e-6, contextWindow: 128_000 },
