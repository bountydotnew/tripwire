...
export function makeSpec(type: string, props: Record<string, unknown>): JsonRenderSpec {
	return {
		root: "main",
		elements: {
...
> {
	 ...
	 */
	handler: (args: z.infer<z.ZodObject<TShape>>, ctx: ToolContext) => Promise<TOutput>;
